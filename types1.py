...
class Question(QuestionBase):
    ...
    def as_string(self):
        type_as_string = "type(" +  str(self.mylist) + ")"
...
def get_questions():
    ...
    for group_id, mylist in enumerate(lists):
        ...
        for type_ in lists[group_id]:
            ...
            yield Question(group, type_, result)


wrong_answers0 = [Answer("<class 'double'>"), Answer("<class 'long'>"),
                  Answer("<class 'integer'>"), Answer("<class 'string'>"),
                  Answer("<class 'number'>")]

wrong_answers1 = [Answer("<class 'string'>"), Answer("<class 'char'>"), 
                  Answer("<class 'int'>"), Answer("<class 'complex'>")]
