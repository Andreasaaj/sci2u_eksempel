...
class Question(QuestionBase):
    ...
    def as_string(self):
        return "list(range({}))".format(self.mylist)
...
def get_questions():
    ...
    lists = [['-1, 2', '0, 2', '1, 2', '2, 2', '3, 2',
             '-1, 2, 1', '0, 2, 1', '1, 2, 1', '2, 2, 1', '3, 2, 1',
             '-1, 2, -1', '0, 2, -1', '1, 2, -1', '2, 2, -1', '3, 2, -1',
             '-1, 5, 2', '0, 5, 2', '1, 5, 2', '2, 5, 2', '3, 5, 2']]
    question_problem = "list(range({}))"
    prefix = "q = "
    suffix = ""
...
wrong_answers0 = [Answer("InvalidListError")]
